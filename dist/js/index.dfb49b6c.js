...
(0, _elementsDefine.elementsDefine)('sidra-research', _sidraResearch.SidraResearchElement);
...
},{"./helpers/elements-define":1,"./services/SidraService":5,"./sidraResearch/sidra-research.element":8}],4:[function(require,module,exports){
"use strict";
...
var _index = require('../sidraResearch/index');
        ...
        value: function getListPesquisas() {
            return this._requestService.getJSON(this._baseUrl).then(function (response) {
                return response.map(function (obj) {
                    return new _index.SidraResearch(_index.SidraResearch.convert(obj));
                });
            }).catch(function (err) {
...
},{"../sidraResearch/index":7,"./RequestService":4}],6:[function(require,module,exports){
"use strict";
    ...
    _createClass(SidraResearch, [{
        ...
        value: function filterTables(term) {
            ...
            return this.tables.filter(function (table) {
                return table.alias.includes(_term);
            });
        }
    }, {
        key: "getTable",
...
var _SidraResearch = require('./SidraResearch.model');

Object.defineProperty(exports, 'SidraResearch', {
  enumerable: true,
  get: function get() {
    return _SidraResearch.SidraResearch;
  }
});

var _sidraResearch = require('./sidra-research.element');

Object.defineProperty(exports, 'SidraResearchElement', {
  enumerable: true,
  get: function get() {
    return _sidraResearch.SidraResearchElement;
  }
});

},{"./SidraResearch.model":6,"./sidra-research.element":8}],8:[function(require,module,exports){
"use strict";
...
var SidraResearchElement = exports.SidraResearchElement = function (_CustomElement2) {
    ...
    _createClass(SidraResearchElement, [{
        ...
        key: "_convertInnerTemplate",
        value: function _convertInnerTemplate() {
            var template = this.querySelector('template');
            var researchTitle = template.querySelector('[research-title]') || document.createElement('h3');
            researchTitle.className = researchTitle.className + ' sidra-research__research-title';
            this._dom.researchTitle = researchTitle;
        }
    }, {
        key: "_hasInnerTemplate",
        value: function _hasInnerTemplate() {
